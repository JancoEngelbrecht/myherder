    ...
    <div class="page-content">
      ...
      <template v-else>
        <div class="list-header">
          ...
          <RouterLink :to="`/log/treatment?animal_id=${animalId}`" class="btn-primary btn-sm-pill">
...
const animalTreatments = computed(() => treatmentsStore.getCowTreatments(animalId))
...
const lifePhase = computed(() => {
  ...
  return computeLifePhase(animal.value, bt)
})
...
async function load() {
  ...
  try {
    ...
    await treatmentsStore.fetchByCow(animalId)
  } catch {
