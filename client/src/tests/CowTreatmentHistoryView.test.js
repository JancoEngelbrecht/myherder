...
import CowTreatmentHistoryView from '../views/CowTreatmentHistoryView.vue'

// Router mock — CowTreatmentHistoryView only uses useRoute, not useRouter
let mockRouteParams = {}
vi.mock('vue-router', () => ({
...
describe('CowTreatmentHistoryView', () => {
  let cowsStore, treatmentsStore
  ...
  it('renders list of treatments for a specific cow', async () => {
    ...
    expect(treatmentsStore.fetchByCow).toHaveBeenCalledWith('cow-1')
  })
