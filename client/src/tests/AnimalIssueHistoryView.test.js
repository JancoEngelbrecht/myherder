...
import AnimalIssueHistoryView from '../views/AnimalIssueHistoryView.vue'

// Router mock — AnimalIssueHistoryView only uses useRoute, not useRouter
let mockRouteParams = {}
vi.mock('vue-router', () => ({
...
describe('AnimalIssueHistoryView', () => {
  let animalsStore, healthIssuesStore, issueTypesStore
