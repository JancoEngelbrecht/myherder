 ...
 *
 * @param {object} animal - animal record with sex, dob, life_phase_override
 ...
 */
export function computeLifePhase(animal, breedType = null, speciesLifePhases = null) {
 ...
 */
export function computeIsReadyToBreed(animal, breedType = null, lastCalvingDate = null) {
