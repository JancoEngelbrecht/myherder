...
export const helpTopics = {
  ...
  'recording-milk': {
    getSteps: (t, s) => [
      ...
      {
        label: t(`help.topics.${s}.flow.withdrawalCheck`), type: 'decision', icon: '⚠',
        branches: [
          { label: t('common.yes'), nodeLabel: t(`help.topics.${s}.flow.showWarning`), type: 'yes', icon: '🚨', nodeType: 'system' },
          { label: t('common.no'), nodeLabel: t(`help.topics.${s}.flow.normalSave`), type: 'no', icon: '✅', nodeType: 'system' },
        ],
      },
    ],
  },
  ...
  'logging-health-issue': {
    getSteps: (t, s) => [
      ...
      {
        label: t(`help.topics.${s}.flow.isMastitis`), type: 'decision', icon: '❓',
        branches: [
          { label: t('common.yes'), nodeLabel: t(`help.topics.${s}.flow.selectTeats`), type: 'yes', icon: '🫁', nodeType: 'action' },
          { label: t('common.no'), nodeLabel: t(`help.topics.${s}.flow.skipTeats`), type: 'no', icon: '⏭', nodeType: 'system' },
        ],
      },
  ...
  'withdrawal-periods': {
    getSteps: (t, s) => [
      ...
      {
        label: t(`help.topics.${s}.flow.periodOver`), type: 'decision', icon: '❓',
        branches: [
          { label: t('common.yes'), nodeLabel: t(`help.topics.${s}.flow.milkSafe`), type: 'yes', icon: '✅', nodeType: 'system' },
          { label: t('common.no'), nodeLabel: t(`help.topics.${s}.flow.discardWarning`), type: 'no', icon: '⚠', nodeType: 'system' },
        ],
      },
    ],
  },
  ...
  'logging-insemination': {
    getSteps: (t, s) => [
      ...
      { label: t(`help.topics.${s}.flow.selectCow`), type: 'action', icon: '🐄' },
      {
        label: t(`help.topics.${s}.flow.selectType`), type: 'decision', icon: '❓',
        branches: [
          { label: t(`help.topics.${s}.flow.ai`), nodeLabel: t(`help.topics.${s}.flow.enterSireAI`), type: 'yes', icon: '💉', nodeType: 'action' },
          { label: t(`help.topics.${s}.flow.bull`), nodeLabel: t(`help.topics.${s}.flow.enterSireBull`), type: 'no', icon: '🐂', nodeType: 'action' },
        ],
      },
      { label: t(`help.topics.${s}.flow.save`), type: 'action', icon: '✅' },
      { label: t(`help.topics.${s}.flow.systemCalc`), type: 'system', icon: '🖥' },
  ...
  'pregnancy-check': {
    getSteps: (t, s) => [
      ...
      { label: t(`help.topics.${s}.flow.selectCow`), type: 'action', icon: '🐄' },
      {
        label: t(`help.topics.${s}.flow.result`), type: 'decision', icon: '🤰',
        branches: [
          { label: t(`help.topics.${s}.flow.positive`), nodeLabel: t(`help.topics.${s}.flow.calvingDate`), type: 'yes', icon: '📅', nodeType: 'system' },
          { label: t(`help.topics.${s}.flow.negative`), nodeLabel: t(`help.topics.${s}.flow.backToCycle`), type: 'no', icon: '🔄', nodeType: 'system' },
        ],
      },
    ],
  },
  ...
  'breeding-notifications': {
    getSteps: (t, s) => [
      ...
      {
        label: t(`help.topics.${s}.flow.actionOrDismiss`), type: 'decision', icon: '❓',
        branches: [
          { label: t(`help.topics.${s}.flow.actLabel`), nodeLabel: t(`help.topics.${s}.flow.logEvent`), type: 'yes', icon: '📝', nodeType: 'action' },
          { label: t(`help.topics.${s}.flow.dismissLabel`), nodeLabel: t(`help.topics.${s}.flow.dismissed`), type: 'no', icon: '✖', nodeType: 'system' },
        ],
      },
    ],
  },
  ...
  'cow-status': {
    getSteps: (t, s) => [
      ...
      {
        label: t(`help.topics.${s}.flow.statusChange`), type: 'decision', icon: '❓',
        branches: [
          { label: t(`help.topics.${s}.flow.dry`), nodeLabel: t(`help.topics.${s}.flow.dryDesc`), type: 'yes', icon: '🚫', nodeType: 'system' },
          { label: t(`help.topics.${s}.flow.soldDead`), nodeLabel: t(`help.topics.${s}.flow.removedDesc`), type: 'no', icon: '📤', nodeType: 'system' },
        ],
      },
    ],
  },
  ...
  'managing-users': {
    getSteps: (t, s) => [
      ...
      {
        label: t(`help.topics.${s}.flow.selectRole`), type: 'decision', icon: '❓',
        branches: [
          { label: t(`help.topics.${s}.flow.admin`), nodeLabel: t(`help.topics.${s}.flow.setPassword`), type: 'yes', icon: '🔑', nodeType: 'action' },
          { label: t(`help.topics.${s}.flow.worker`), nodeLabel: t(`help.topics.${s}.flow.setPin`), type: 'no', icon: '🔢', nodeType: 'action' },
        ],
      },
