...
const tables = ['users', 'cows', 'medications', 'treatments',
  'health_issues', 'health_issue_comments', 'milk_records', 'breeding_events',
  'breed_types', 'issue_type_definitions', 'audit_log'];
...
await knex.raw('CREATE INDEX idx_health_issues_farm_observed ON health_issues(farm_id, observed_at)');
